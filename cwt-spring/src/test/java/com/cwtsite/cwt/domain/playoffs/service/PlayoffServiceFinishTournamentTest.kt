...
class PlayoffServiceFinishTournamentTest {
    ...
    fun advanceByGame_isFinalGame() {
        ...
        Mockito.verify(tournamentService).finish(finalGame.winner(), finalGame.loser(), thirdPlaceGame.winner())
    }
    ...
    fun advanceByGame_isThreeWayFinalGame() {
        ...
        Mockito.verify(tournamentService).finish(user1, user3, user2)
    }
