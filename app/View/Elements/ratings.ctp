...
<div id="boxFloat" class="R"
     style="margin-top:10px; margin-right:5px; width:90px; background-color:#3F3829; padding:15px 10px; height:100px; white-space: nowrap;">
...
<div id="boxFloat" class="C"
     style="margin-top:10px; width:90px; background-color:#3F3829; padding:15px 10px; height:100px; white-space: nowrap;">
    <div style="float:left; margin-right:10px">
