...
<div id="boxFloat" class="ScheduleList"
     style="background-color:#3C3E28; width:475px; height:100px; overflow-y:scroll; padding: 2px 5px;">
            ...
            <?php foreach ($schedules as $schedule): ?>
                <tr>
                    <td align="right">
                        ...
                        <span title="Remove Game" style="color:red; cursor:pointer;"
                              onClick="removeGame(<?php echo $schedule['Schedule']['id'] ?>);">
								x
                            <?php else: ?>
                                »
                            <?php
