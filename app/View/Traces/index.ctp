<?php if (isset($user)): ?>
    <div id="box" style="background-color:#2F2923; text-align:center;">
        <h1>
            <span style="font-weight:normal;">Ratings and Bets by</span>
            <?php
...
<?php elseif (isset($game)): ?>
    <div id="box" style="background-color:#2F2923; text-align:center;">
        <h1>
            <span style="font-weight:normal;">Ratings and Bets of</span>
            <?php
            echo $this->Html->link('Game #' . $game['Game']['id'], '/games/view/' . $game['Game']['id']);
            ?>
        </h1>
    </div>
<?php else: ?>
    <div id="box" style="background-color:#2F2923; text-align:center;">
        <h1>Ratings and Bets</h1>
    </div>
<?php endif; ?>
