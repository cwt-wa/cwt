...
class UploadHelper extends AppHelper {
	...
	public function view ($model, $id, $edit=false) {
		...
		foreach ($files as $file) {
			...
			$str .= "<a href='$url' target=\"_blank\">" . $f . "</a> ($filesize)";
			$str .= "<br />\n";
		}
		$str .= "\n"; 
		return $str;
	...
	public function listing ($model, $id) {
		...
		// $directory = WWW_ROOT . DS . $dir . DS . $lastDir;  I don't want that done! By Zemke.
		// $baseUrl = Router::url("/") . $dir . "/" . $lastDir;  I don't want that done! By Zemke.
		$directory = WWW_ROOT . DS . $dir;
		$baseUrl = Router::url("/") . $dir;
