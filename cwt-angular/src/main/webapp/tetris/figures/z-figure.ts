        ...
        switch (this.getRotateCounter()) {
            case 0:
                ...
                for (let i = 0; i < this.getCells().length; i++) {
                    if (clone.cells[i].yPos === clone.cells[clone.indexOfSmallestYPosition].yPos) continue;
            ...
            case 1:
                ...
                for (let i = 0; i < this.getCells().length; i++) {
                    if (clone.cells[i].yPos === (clone.cells[clone.indexOfSmallestYPosition].yPos + 1)) continue;
