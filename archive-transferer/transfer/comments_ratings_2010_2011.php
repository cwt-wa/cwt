...
$tournamentId = 9; // id 10 = year 2011
$assocGroups = array('a', 'b', 'c', 'd', 'e', 'f', 'g', 'h');

foreach ($assocGroups as $assocGroup) {
    $sqlComments = "SELECT * FROM `comments$assocGroup`";
    $resultComments = mysqli_query($db2010, $sqlComments);
